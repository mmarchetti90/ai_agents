...
class MemoryHandler:
    ...
    def __init__(self, memory_path: str, model_checkpoint: str, device_map: str, similarity_fn_name: str='cosine') -> None:

        self.memory_path = memory_path
        self.init_rag(model_checkpoint, device_map, similarity_fn_name)
    ...
    def init_rag(self, model_checkpoint: str, device_map: str='auto', similarity_fn_name: str='cosine') -> None:
    ...
    def transform_memory(self, text: list[str]) -> NDArray:
        ...
        embeddings = self.embedder_model.encode(text)
    ...
    def compare_memories(
        ...
        similarity = self.embedder_model.similarity(query_embedding, data_embedding)
        top_hits = {}
