...
if __name__ == '__main__':
    ...
    memory_instance = MemoryHandler(
        ...
        config_data['memory']['device_map'],
        config_data['memory']['similarity_fn_name']
    )
    ...
    for mta in memories_to_add:
        memory_instance.log_memory(origin='agent', content=mta)
    ...
    retrieved_memories = memory_instance.retrieve_memory(context=context, max_hits=5, score_threshold=memory_score_threshold)
