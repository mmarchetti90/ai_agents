...
class query_decomposition:
    ...
    def __init__(self, model_checkpoint: str, device_map: str='cpu', max_new_tokens=256, max_tasks: int=5):
...
"""
    ...
    @torch_no_grad()
    def forward(self, query: str, context: str='') -> list[str]:
...
if __name__ == '__main__':
    ...
    text_generator = query_decomposition(model_checkpoint='Qwen/Qwen3-0.6B')
