...
class task_assigner:
    ...
    def __init__(self, model_checkpoint: str, device_map: str='cpu', max_new_tokens=256):
...
"""
    ...
    @torch_no_grad()
    def forward(self, tasks: list[str], tools_description: str, context: str='') -> list[str, dict]:
