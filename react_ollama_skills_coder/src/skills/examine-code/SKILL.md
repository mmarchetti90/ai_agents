...
```json
{
  ...
  "element" : "The name of the element to be examined (e.g. function, class). If 'all', examine all elements in the file.",
...
```python
def examine_code(code_path: str, element: str, element_type: str):
  """
...
I examined the code and generated a report.
